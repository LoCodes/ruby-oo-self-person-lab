...
class Person 
    ...
    def take_bath
        self.hygiene += 4   #called on self(take_bath).hygiene (hygiene method combined)
    ...
    def call_friend(friend)
        [friend, self].each do |add_points|    #better code than below
            add_points.happiness += 3
        end 
